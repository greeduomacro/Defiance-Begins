...
// --- --- ---
		...
		public static int Damage( Mobile m, Mobile from, int damage, int phys, int fire, int cold, int pois, int nrgy, bool keepAlive, bool archer )
		{
			return Damage( m, from, damage, false, phys, fire, cold, pois, nrgy, keepAlive, archer );
		}

		public static int Damage( Mobile m, Mobile from, int damage, int phys, int fire, int cold, int pois, int nrgy, int chaos, int direct, bool keepAlive )
		{
			return Damage( m, from, damage, false, phys, fire, cold, pois, nrgy, chaos, direct, keepAlive );
		}

		public static int Damage( Mobile m, Mobile from, int damage, int phys, int fire, int cold, int pois, int nrgy, int chaos, int direct, bool keepAlive, bool archer )
		{
			return Damage( m, from, damage, false, phys, fire, cold, pois, nrgy, chaos, direct, keepAlive, archer );
		}

		public static int Damage( Mobile m, Mobile from, int damage, int phys, int fire, int cold, int pois, int nrgy, int chaos, int direct, bool keepAlive, bool archer, bool deathstrike )
		{
			return Damage( m, from, damage, false, phys, fire, cold, pois, nrgy, chaos, direct, keepAlive, archer, deathstrike );
		}
...
// -- -- --
		...
		{
			return Damage( m, from, damage, ignoreArmor, phys, fire, cold, pois, nrgy, keepAlive, false );
		}

		public static int Damage( Mobile m, Mobile from, int damage, bool ignoreArmor, int phys, int fire, int cold, int pois, int nrgy, bool keepAlive, bool archer )
		{
			return Damage( m, from, damage, ignoreArmor, phys, fire, cold, pois, nrgy, 0, 0, keepAlive, archer );
		}

		public static int Damage( Mobile m, Mobile from, int damage, bool ignoreArmor, int phys, int fire, int cold, int pois, int nrgy, int chaos, int direct, bool keepAlive )
		{
			return Damage( m, from, damage, ignoreArmor, phys, fire, cold, pois, nrgy, chaos, direct, keepAlive, false );
		}
		...
		{
			return Damage( m, from, damage, ignoreArmor, phys, fire, cold, pois, nrgy, chaos, direct, keepAlive, archer, false );
		}
