...
*/
				Register( new PoisonImpl( "Lesser",		0,  2,  26,  1.750, 3.25, 2.75, 10, 2 ) );
				Register( new PoisonImpl( "Regular",	1,  5,  26,  3.125, 3.25, 2.75, 10, 2 ) );
				Register( new PoisonImpl( "Greater",	2,  7,  26,  6.250, 4.00, 3.50, 10, 2 ) );
				Register( new PoisonImpl( "Deadly",		3,  6,  26, 12.500, 5.00, 5.00, 10, 2 ) );
				Register( new PoisonImpl( "Lethal",		4, 10,  26, 25.000, 5.00, 5.00, 10, 2 ) );
			}
				Register( new PoisonImpl( "Fatal", 		5, 12,  26, 35.000, 4.75, 4.75, 10, 4 ) );
		}
