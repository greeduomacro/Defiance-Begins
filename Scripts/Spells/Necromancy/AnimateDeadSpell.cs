...
namespace Server.Spells.Necromancy
{
	public class AnimateDeadSpell : NecromancerSpell
	{
		...
		private static CreatureGroup[] m_Groups = new CreatureGroup[]
			{
				...
				}, new SummonEntry[]
				{
					...
					new SummonEntry(  1000, typeof( SkeletalMage ), typeof( BoneMage ) ),
		...
		public static void Register( Mobile master, Mobile summoned )
		{
			...
			Timer.DelayCall<Mobile>( TimeSpan.FromSeconds( 2.0 ), TimeSpan.FromSeconds( 2.0 ), new TimerStateCallback<Mobile>( Summoned_Damage ), summoned );
		}
