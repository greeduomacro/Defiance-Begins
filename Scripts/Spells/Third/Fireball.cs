	...
	public class FireballSpell : MagerySpell
	{
		...
		public void Target( Mobile m )
		{
			...
			else if ( CheckHSequence( m ) )
			{
				...
				{
					//damage = Utility.Random( 7, 5 ); // 7 - 11
					damage = Utility.Dice( 2, 3, 5 );
				...
				SpellHelper.Damage( this, TimeSpan.FromSeconds( 0.13 * Math.Min( dist, 6.0 ) ), target, damage, 0, 100, 0, 0, 0, m );
