...
namespace Server.Spells
{
	...
	public class SpellHelper
	{
		...
		{
			return AddStatBonus( caster, target, type, GetOffset( caster, target, type, false, skillcheck ), GetDuration( caster, target ) );
		}
		...
		{
			return AddStatCurse( caster, target, type, GetOffset( caster, target, type, true, skillcheck ), GetDuration( caster, target ) );
		}
...
/* Recall From */		{ true,			false,			false,			false,		false,			false,			false,		false,				false,				false,				false,			false,			false,				false,				false,			false },
/* Recall To */			{ true,			false,			false,			false,		false,			false,			false,		false,				false,				false,				false,			false,			false,				false,				false,			false },
/* Gate From */			{ true,			false,			false,			false,		false,			false,			false,		false,				false,				false,				false,			false,			false,				false,				false,			false },
/* Gate To */			{ true,			false,			false,			false,		false,			false,			false,		false,				false,				false,				false,			false,			false,				false,				false,			false },
/* Mark In */			{ true,			false,			false,			false,		false,			false,			false,		false,				false,				false,				false,			false,			false,				false,				false,			false },
...
/* Tele To */			{ true,			true,			true,			true,		true,			true,			true,		false,				true,				false,				false, 			true,			true,				true,				true,			false },
		...
		{
			Damage( spell, target, damage, target );
		}

		public static void Damage( Spell spell, Mobile target, double damage, Mobile origTarget )
		{
			TimeSpan ts = GetDamageDelayForSpell( spell );

			Damage( spell, ts, target, spell.Caster, damage, origTarget );
		}

		public static void Damage( TimeSpan delay, Mobile target, double damage )
		{
			Damage( delay, target, damage, target );
		}

		public static void Damage( TimeSpan delay, Mobile target, double damage, Mobile origTarget )
		{
			Damage( delay, target, null, damage, origTarget );
		}

		public static void Damage( TimeSpan delay, Mobile target, Mobile from, double damage )
		{
			Damage( delay, target, from, damage, target );
		}

		public static void Damage( TimeSpan delay, Mobile target, Mobile from, double damage, Mobile origTarget )
		{
			Damage( null, delay, target, from, damage, origTarget );
		}

		public static void Damage( Spell spell, TimeSpan delay, Mobile target, double damage )
		{
			Damage( spell, delay, target, damage, target );
		}

		public static void Damage( Spell spell, TimeSpan delay, Mobile target, double damage, Mobile origTarget )
		{
			Damage( spell, delay, target, spell.Caster, damage, origTarget );
		}

		public static void Damage( Spell spell, TimeSpan delay, Mobile target, Mobile from, double damage )
		{
			Damage( spell, delay, target, from, damage, target );
		}

		public static void Damage( Spell spell, TimeSpan delay, Mobile target, Mobile from, double damage, Mobile origTarget )
		{
			int iDamage = (int)damage;

			if( delay == TimeSpan.Zero )
			{
				from.DoHarmful( origTarget );
			...
			{
				if ( origTarget.Player )
					from.DoHarmful( origTarget );
				new SpellDamageTimer( spell, target, from, iDamage, delay, origTarget ).Start();
			}
		}

		public static void Damage( Spell spell, Mobile target, double damage, int phys, int fire, int cold, int pois, int nrgy )
		{
			Damage( spell, target, damage, phys, fire, cold, pois, nrgy, target );
		}

		public static void Damage( Spell spell, Mobile target, double damage, int phys, int fire, int cold, int pois, int nrgy, Mobile origTarget )
		{
			TimeSpan ts = GetDamageDelayForSpell( spell );

			Damage( spell, ts, target, spell.Caster, damage, phys, fire, cold, pois, nrgy, DFAlgorithm.Standard, origTarget );
		}
		...
		{
			Damage( spell, target, damage, phys, fire, cold, pois, nrgy, dfa, target );
		}

		public static void Damage( Spell spell, Mobile target, double damage, int phys, int fire, int cold, int pois, int nrgy, DFAlgorithm dfa, Mobile origTarget )
		{
			TimeSpan ts = GetDamageDelayForSpell( spell );

			Damage( spell, ts, target, spell.Caster, damage, phys, fire, cold, pois, nrgy, dfa, origTarget );
		}

		public static void Damage( TimeSpan delay, Mobile target, double damage, int phys, int fire, int cold, int pois, int nrgy )
		{
			Damage( delay, target, damage, phys, fire, cold, pois, nrgy, target );
		}

		public static void Damage( TimeSpan delay, Mobile target, double damage, int phys, int fire, int cold, int pois, int nrgy, Mobile origTarget )
		{
			Damage( delay, target, null, damage, phys, fire, cold, pois, nrgy, origTarget );
		}
		...
		{
			Damage( delay, target, from, damage, phys, fire, cold, pois, nrgy, target );
		}

		public static void Damage( TimeSpan delay, Mobile target, Mobile from, double damage, int phys, int fire, int cold, int pois, int nrgy, Mobile origTarget )
		{
			Damage( delay, target, from, damage, phys, fire, cold, pois, nrgy, DFAlgorithm.Standard, origTarget );
		}
		...
		{
			Damage( delay, target, from, damage, phys, fire, cold, pois, nrgy, dfa, target );
		}

		public static void Damage( TimeSpan delay, Mobile target, Mobile from, double damage, int phys, int fire, int cold, int pois, int nrgy, DFAlgorithm dfa, Mobile origTarget )
		{
			Damage( null, delay, target, from, damage, phys, fire, cold, pois, nrgy, dfa, origTarget );
		}
		...
		{
			Damage( spell, delay, target, damage, phys, fire, cold, pois, nrgy, target );
		}

		public static void Damage( Spell spell, TimeSpan delay, Mobile target, double damage, int phys, int fire, int cold, int pois, int nrgy, Mobile origTarget )
		{
			Damage( spell, delay, target, spell.Caster, damage, phys, fire, cold, pois, nrgy, DFAlgorithm.Standard, origTarget );
		}

		public static void Damage( Spell spell, TimeSpan delay, Mobile target, double damage, int phys, int fire, int cold, int pois, int nrgy, DFAlgorithm dfa )
		{
			Damage( spell, delay, target, spell.Caster, damage, phys, fire, cold, pois, nrgy, dfa, target );
		}

		public static void Damage( Spell spell, TimeSpan delay, Mobile target, Mobile from, double damage, int phys, int fire, int cold, int pois, int nrgy, DFAlgorithm dfa, Mobile origTarget )
		{
			int iDamage = (int)damage;
			...
			else
			{
				if ( origTarget.Player )
					from.DoHarmful( origTarget );
				new SpellDamageTimerAOS( spell, target, from, iDamage, phys, fire, cold, pois, nrgy, delay, dfa, origTarget ).Start();
			}
		}
		...
		{
			private Mobile m_Target, m_From, m_OrigTarget;
			private int m_Damage;
			private Spell m_Spell;

			public SpellDamageTimer( Spell s, Mobile target, Mobile from, int damage, TimeSpan delay, Mobile origTarget )
				: base( delay )
			{
				m_Target = target;
				m_From = from;
			...
			protected override void OnTick()
			{
				if ( !m_OrigTarget.Player )
					m_From.DoHarmful( m_OrigTarget );
		...
		private class SpellDamageTimerAOS : Timer
		{
			...
			public SpellDamageTimerAOS( Spell s, Mobile target, Mobile from, int damage, int phys, int fire, int cold, int pois, int nrgy, TimeSpan delay, DFAlgorithm dfa, Mobile origTarget )
				: base( delay )
			{
				m_Target = target;
				m_From = from;
