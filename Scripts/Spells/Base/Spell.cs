...
namespace Server.Spells
{
	public abstract class Spell : ISpell
	{
		...
		private static TimeSpan NextSpellDelay = TimeSpan.FromSeconds( 0.95 );
		...
		private class CastTimer : Timer
		{
			...
			protected override void OnTick()
			{
				if ( m_Spell.State == SpellState.Casting && m_Spell.Caster.Spell == m_Spell )
				{
					...
					m_Spell.Caster.NextSpellTime = DateTime.Now + m_Spell.GetCastRecovery();// Spell.NextSpellDelay;
