	...
	public class JusticeVirtue
	{
		...
		public static void OnVirtueRejected( PlayerMobile protector, PlayerMobile protectee )
		{
			...
			if ( protector.BeginAction( typeof( JusticeVirtue ) ) )
				Timer.DelayCall<Mobile>( TimeSpan.FromMinutes( 15.0 ), new TimerStateCallback<Mobile>( RejectDelay_Callback ), protector );
		}

		public static void RejectDelay_Callback( Mobile m )
		{
			if ( m != null )
