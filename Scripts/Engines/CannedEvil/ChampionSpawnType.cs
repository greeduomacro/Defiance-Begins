		...
		private static readonly ChampionSpawnInfo[] m_Table = new ChampionSpawnInfo[]
			{
				...
				{																											// Cold Blood
					new Type[]{ typeof( Lizardman ), typeof( GiantSerpent ) },														// Level 1
				...
				{																											// Unholy Terror
					...
					new Type[]{ typeof( BoneMage ), typeof( Mummy ), typeof( SkeletalMage ) },								// Level 2
				...
				//For halloween
				new ChampionSpawnInfo( "Graveyard", typeof( GrimReaper ), new string[]{ "Trickster", "Prankster", "Terrorist" }, new Type[][]	// Graveyard
				{																										// Graveyard
					new Type[]{ typeof( HalloweenGhoul ), typeof( GreaterMongbat ), typeof( Spectre ), typeof( Wraith ) },					// Level 1
					new Type[]{ typeof( BoneMage ), typeof( GraveyardBoneMage ), typeof( SkeletalMage ) },								// Level 2
					new Type[]{ typeof( BoneKnight ), typeof( Lich ), typeof( SkeletalKnight ), typeof( Mummy ) },							// Level 3
					new Type[]{ typeof( LichLord ), typeof( RottingCorpse ), typeof( SpiritHunter ) }									// Level 4
				} )
			};
