...
namespace Server.Mobiles
{
	public class DreadLord : BaseCreature, IRangedMelee
	{
		...
		public DreadLord() : base( AIType.AI_RangedMelee, FightMode.Closest, 10, 1, 0.1, 0.1 )
		{
			...
			AddItem( NotCorpseCont( new RoyalPlateChest() ) );
			AddItem( NotCorpseCont( new RoyalPlateArms() ) );
			AddItem( NotCorpseCont( new RoyalPlateHelm() ) );
			AddItem( NotCorpseCont( new RoyalPlateGloves() ) );
			AddItem( NotCorpseCont( new RoyalPlateLegs() ) );
			AddItem( NotCorpseCont( new RoyalPlateGorget() ) );
			AddItem( NotCorpseCont( new RoyalPlateBoots() ) );
