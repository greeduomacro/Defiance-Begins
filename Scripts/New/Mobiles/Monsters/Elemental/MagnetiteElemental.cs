...
namespace Server.Mobiles
{
	...
	public class MagnetiteElemental : BaseCreature
	{
		...
		public override void GenerateLoot( bool spawning )
		{
			...
			if ( !spawning && Utility.Random( 25 ) == 0 )
		...
		public override void AlterMeleeDamageFrom( Mobile from, ref int damage )
		{
			...
			if ( from is PlayerMobile && SkillHandlers.Discordance.GetEffect( this, ref discordanceEffect ) )
			{
				BaseWeapon weapon = from.FindItemOnLayer( Layer.FirstValid ) as BaseWeapon;
