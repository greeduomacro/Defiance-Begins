...
namespace Server.Items
{
	public abstract class BaseConflagrationPotion : BasePotion
	{
		...
		public static void AddDelay( Mobile m )
		{
			...
			m_Delay[m] = Timer.DelayCall<Mobile>( TimeSpan.FromSeconds( 30 ), new TimerStateCallback<Mobile>( EndDelay ), m );
		}
		...
		private class ThrowTarget : Target
		{
			...
			protected override void OnTarget( Mobile from, object targeted )
			{
				...
				Timer.DelayCall<IEntity[]>( TimeSpan.FromSeconds( 1.5 ), new TimerStateCallback<IEntity[]>( m_Potion.Explode_Callback ), new IEntity[]{ from, to } );
			}
		}
