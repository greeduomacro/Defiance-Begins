...
{
	public abstract class BaseArmor : Item, IScissorable, IFactionItem, ICraftable, IWearableDurability, IEthicsItem
	{
		#region Ethics
		...
		public CraftResource Resource
		{
			...
			set
			{
				if ( m_Resource != value )
				{
					...
					if ( DefTailoring.IsColorable( this.GetType() ) )
...
//						m_ArmorBase = -1;
		...
		public virtual int OnHit( BaseWeapon weapon, Mobile attacker, int damageTaken )
		{
			...
			int Absorbed = (int)ArmorRatingScaled( attacker );
