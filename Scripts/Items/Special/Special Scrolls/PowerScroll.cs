...
namespace Server.Items
{
	public class PowerScroll : SpecialScroll
	{
		...
		private static SkillName[] m_OldSkills = new SkillName[]
			{
		...
		private static List<SkillName> m_Skills = new List<SkillName>();
				...
				if ( m_Skills.Count == 0 )
				{
					...
					if (Core.AOS)
					{
						...
						if (Core.SE)
						{
							...
							if (Core.ML)
								m_Skills.Add( SkillName.Spellweaving );
						}
					}
				}
				return m_Skills;
