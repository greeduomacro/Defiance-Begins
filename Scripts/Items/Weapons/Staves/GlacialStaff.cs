	...
	public class GlacialStaff : BlackStaff, IUsesRemaining
	{
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			if ( from != Parent )
				...
				from.SendMessage( "You must rest before using a staff again." ); // You must rest before using this staff again.
			else
			{
...
*/
		...
		public override void OnAdded( object parent )
		{
			...
			{
				AOS.Damage( from,  from, Utility.Random( 5, 11 ), true, 25, 0, 75, 0, 0, 0, 0, true, false );
