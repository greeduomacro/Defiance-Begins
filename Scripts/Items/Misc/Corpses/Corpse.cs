...
namespace Server.Items
{
	...
	public class Corpse : Container, ICarvable
	{
		...
		private List<Item>			m_EquipItems;			// List of items equipped when the owner died. Ingame, these items display /on/ the corpse, not just inside
