...
namespace Server.Mobiles
{
	public abstract class BaseChampion : BaseCreature
	{
		...
		public BaseChampion( AIType aiType, FightMode mode, 
			int perception, int rangeFight, double activeSpeed, 
			double passiveSpeed ) : base( aiType, mode, perception, rangeFight, activeSpeed, passiveSpeed )
		{
		}
		...
		{
			if ( SkullType != ChampionSkullType.None && Map == Map.Felucca )
			{
