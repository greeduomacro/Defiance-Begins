...
namespace Server.Mobiles
{
	...
	public class BaseCreature : Mobile, IHonorTarget, IBegged
	{
...
/*
			if ( IsStabled )
			{
				Console.WriteLine( "Stables: {0} ({1}), pet of {2} deleted.", GetType(), Serial, m );
				throw new Exception( String.Format( "Pet deleted from stables {0} ({1}), pet of {2}", GetType(), Serial, m ) );
			}
*/
