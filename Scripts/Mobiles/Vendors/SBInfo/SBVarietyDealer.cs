	...
	public class SBVarietyDealer : SBInfo
	{
		...
		public class InternalBuyInfo : List<IBuyItemInfo>
		{
			public InternalBuyInfo()
			{
				...
				Add( new GenericBuyInfo( "lesser lethargy potion", typeof( LesserLethargyPotion ), 15750, 5, 0xE24, 1278 ) );
 				Add( new GenericBuyInfo( "lesser amnesia potion", typeof( LesserAmnesiaPotion ), 15750, 5, 0xE24, 1282 ) );
				Add( new GenericBuyInfo( "lesser cripple potion", typeof( LesserCripplePotion ), 15750, 5, 0xE24, 1281 ) );
