...
namespace Server.Mobiles
{
	...
	public class MeerEternal : BaseCreature
	{
		...
		private void DoFocusedLeech( Mobile combatant, string message )
		{
			...
			Timer.DelayCall<Mobile>( TimeSpan.FromSeconds( 0.5 ), new TimerStateCallback<Mobile>( DoFocusedLeech_Stage1 ), combatant );
		}
		...
		private void DoFocusedLeech_Stage1( Mobile combatant )
		{
			if ( this.CanBeHarmful( combatant ) )
			{
				...
				Timer.DelayCall<Mobile>( TimeSpan.FromSeconds( 1.0 ), new TimerStateCallback<Mobile>( DoFocusedLeech_Stage2 ), combatant );
			}
		}
