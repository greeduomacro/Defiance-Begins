...
namespace Server.Mobiles
{
	public class MageAI : BaseAI
	{
		...
		public virtual double TeleportChance{ get{ return 0.005; } }
		public virtual double DispelChance{ get{ return 0.25; } }
...
*/
		...
		{
			int maxCircle = (int)((MagerySkill + 20.0) / (100.0 / 7.0));
...
*/
		...
		public virtual double NecroSkill{ get{ return m_Mobile.Skills[ SkillName.Magery ].Value; } }
		public virtual double MagerySkill{ get{ return m_Mobile.Skills[ SkillName.Magery ].Value; } }
		public virtual double SpiritSpeakSkill{ get{ return m_Mobile.Skills[ SkillName.SpiritSpeak ].Value; } }
