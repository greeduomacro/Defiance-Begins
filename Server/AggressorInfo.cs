...
namespace Server
{
	public class AggressorInfo
	{
		...
		private bool m_Provoked; // Defender has been provoked by attacker (initial blow)
		...
		{
			return Create( attacker, defender, criminal, heal, false );
		}

		public static AggressorInfo Create( Mobile attacker, Mobile defender, bool criminal, bool heal, bool provoked )
		{
			AggressorInfo info;
			...
			{
				info = new AggressorInfo( attacker, defender, criminal, heal, provoked );
			}
		...
		private AggressorInfo( Mobile attacker, Mobile defender, bool criminal, bool heal, bool provoked )
		{
			m_Attacker = attacker;
			m_Defender = defender;
