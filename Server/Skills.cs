...
namespace Server
{
	...
	public class SkillInfo
	{
		...
		public bool UsesDifficulty
		{
			get
			{
				return m_UsesDifficulty;
			}
			set
			{
				m_UsesDifficulty = value;
			}
		}
		...
		private static SkillInfo[] m_Table = new SkillInfo[58]
			{
				...
				new SkillInfo(  6, "Begging",			0.0,	0.0,	0.0,	"Beggar",	null,	0.0,	0.0,	0.0,	1.0, false ),
				new SkillInfo(  7, "Blacksmithy",		10.0,	0.0,	0.0,	"Blacksmith",	null,	1.0,	0.0,	0.0,	1.0, true ),
				new SkillInfo(  8, "Bowcraft/Fletching",	6.0,	16.0,	0.0,	"Bowyer",	null,	0.6,	1.6,	0.0,	1.0, true ),
