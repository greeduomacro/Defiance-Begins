...
namespace Server
{
	...
	public class StatMod
	{
		...
		{
			return m_Duration != TimeSpan.Zero && (DateTime.Now - m_Added) >= m_Duration;
		}
	...
	public class Mobile : IEntity, IHued, IComparable<Mobile>, ISerializable, ISpawnable
	{
		...
		public virtual void AggressiveAction( Mobile aggressor, bool criminal, bool healing, bool sendMessage )
		{
			...
			if ( addAggressor )
			{
				m_Aggressors.Add( AggressorInfo.Create( aggressor, this, criminal, false, addAggressor && addAggressed ) ); // new AggressorInfo( aggressor, this, criminal, true ) );
			...
			if ( addAggressed )
			{
				aggressor.m_Aggressed.Add( AggressorInfo.Create( aggressor, this, criminal, healing, addAggressor && addAggressed ) ); // new AggressorInfo( aggressor, this, criminal, false ) );
		...
		public virtual void OnDeath( Container c )
		{
			...
			else
			{
				...
				deathShroud.Name = "a ghostly figure";
			...
			if( map != null )
			{
				...
				foreach( NetState state in eable )
				{
					if( state.Mobile.CanSee( this ) )
					{
						...
						//if ( state.NewMobileAnimation ) {
						//	if( pNew == null )
						//		pNew = Packet.Acquire( new NewMobileAnimation( this, action, frameCount, Utility.Random( 100 ) ) );
